...
def display_chat_interface():
    for message in st.session_state.messages:
        if message["role"] == "system":
            continue
        avatar = "padty.png" if message["role"] == "assistant" else "https://raw.githubusercontent.com/madlittledude/PADTY/colin.png"
    ...
    if prompt:
        ...
        with st.chat_message("assistant", avatar="https://raw.githubusercontent.com/madlittledude/PADTY/padty.png"):
